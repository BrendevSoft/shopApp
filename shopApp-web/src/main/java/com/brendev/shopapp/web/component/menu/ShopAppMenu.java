 ...
 */
package com.brendev.shopapp.web.component.menu;
...
@ListenerFor(sourceClass = ShopAppMenu.class, systemEventClass = PostAddToViewEvent.class)
public class ShopAppMenu extends AbstractMenu implements Widget,ComponentSystemEventListener {
