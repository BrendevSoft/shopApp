 ...
 */
package com.brendev.securityapp.template.component.menu;
...
@ListenerFor(sourceClass = SecurityAppMenu.class, systemEventClass = PostAddToViewEvent.class)
public class SecurityAppMenu extends AbstractMenu implements Widget,ComponentSystemEventListener {
